    ...
    $(document).ready(() => {
        ...
        $(document).on('click', '[role="make-success"]', function(e) {
            ...
            <form method="post" class="margin-b-4">
                <?=$insertHiddenToken;?>
                <input type="hidden" name="<?=reportController::INPUT_ACTION;?>" value="<?=reportController::ACTION_MAKE_SUCCESS;?>">
                <input type="hidden" name="<?=reportController::INPUT_ID;?>" value="${report.id}">
        ...
        $(document).on('click', '[role="make-reject"]', function(e) {
            ...
            <form method="post" class="margin-b-4">
                <?=$insertHiddenToken;?>
                <input type="hidden" name="<?=reportController::INPUT_ACTION;?>" value="<?=reportController::ACTION_MAKE_REJECT;?>">
                <input type="hidden" name="<?=reportController::INPUT_ID;?>" value="${report.id}">
        ...
        $(document).on('click', '[role="make-pending"]', function(e) {
            ...
            <form method="post" class="margin-b-4">
                <?=$insertHiddenToken;?>
                <input type="hidden" name="<?=reportController::INPUT_ACTION;?>" value="<?=reportController::ACTION_MAKE_PENDING;?>">
                <input type="hidden" name="<?=reportController::INPUT_ID;?>" value="${report.id}">
