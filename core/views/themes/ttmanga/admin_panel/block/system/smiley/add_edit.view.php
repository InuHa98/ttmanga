...
?>
	...
	<form id="form-validate" method="POST">
        ...
        <div class="mb-2"><?=$txt_description;?></div>
			...
			<div class="form-group limit--width">
                ...
                <div class="form-control">
                    <input class="form-input" name="<?=adminPanelController::INPUT_SMILEY_NAME;?>" placeholder="Tên nhãn dán" type="text" value="<?=_echo($name);?>">
                </div>
			</div>
            <div class="form-group">
                ...
                <div class="form-control">
                    <div class="input-group">
                        <input class="form-input" name="<?=adminPanelController::INPUT_SMILEY_IMAGES;?>[]" placeholder="https://" type="text">
            ...
            <div class="smiley-edit-box mt-2">
            <?php if(isset($images)): ?>
                ...
                <div class="smiley-edit-box__item">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <input class="form-input" name="<?=adminPanelController::INPUT_SMILEY_IMAGES;?>[]" placeholder="https://" type="text" value="<?=_echo($image);?>">
                            <div class="input-group-append">
        ...
        <div class="d-flex justify-content-end my-4">
            ...
            <a href="<?=Request::referer(RouteMap::get('admin_panel', ['group' => adminPanelController::GROUP_SYSTEM, 'block' => adminPanelController::BLOCK_SMILEY]));?>" class="btn btn--round btn--gray pull-right">Trở lại</a>
		</div>
	</form>
